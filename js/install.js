...
(function(){
  ...
  async function install(){
    ...
    openModal('Install Astra Temple', '<p>Open this game in Chrome on your Pixel, then use the browser menu → Add to Home screen → Install.</p><p>If this link opened inside another app, choose Open in Chrome first. On iPhone or iPad, open it in Safari and choose Share → Add to Home Screen.</p><p>Wait for “Offline copy ready” before playing without a connection. An already installed app can be opened from your home screen.</p>',[{label:'Close',fn:closeModal}]);
